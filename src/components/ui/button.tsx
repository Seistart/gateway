  ...
  "inline-flex items-center justify-center whitespace-nowrap text-xs font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        rounded:
          "border border-input rounded-md bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        outline:
          "border border-input bg-quinary shadow-sm hover:bg-quinary/20 hover:text-accent-foreground",
        white:
          "border border-input bg-quantenary text-quinary shadow-sm hover:bg-white/60 hover:text-accent-foreground",
        secondary:
